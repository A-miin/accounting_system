...
class MembershipFeeAdmin(admin.ModelAdmin):
    list_per_page = 100
    list_display = ['id', 'full_name', 'amount', 'payed_at', 'transfer_type', 'is_payed', 'pay']
    ...
    def pay(self, obj):
        if not obj.is_payed:
            return format_html(
                '''
                <a class="btn btn-success" href="{}" style="color: green" >
                ...
                ''',
                reverse('webapp:membeshipfee-pay', kwargs={'pk': obj.pk}),
            )

    pay.short_description = _("Башкаруу")
